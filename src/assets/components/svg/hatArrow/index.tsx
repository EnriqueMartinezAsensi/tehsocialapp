import { HatArrowSvg } from "./HatArrow.styled";
import "./styles.css";
...
const HatArrow = ({ size, angle, color }: HatArrowProps) => {
  return (
    <HatArrowSvg
      className="hatarrow"
      version="1.1"
